...
final class GuidedTours
{
    ...
    private static function month(): array
    {
        return [
            ...
            ['element' => 'month-export', 'title' => 'Exportar a Excel', 'description' => 'Descarga el libro del mes con tres hojas: Indicadores (el cuadro con el mismo orden de columnas del Excel original), Anual (la tabla del año) y Tasas (la tasa de cada día con su origen).', 'side' => 'bottom', 'align' => 'end', 'can' => 'reports.export'],
