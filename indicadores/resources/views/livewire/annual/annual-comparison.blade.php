<div class="space-y-6">
    <div class="flex flex-wrap items-end justify-between gap-3">
        ...
        <div class="flex flex-wrap items-center gap-2">
            <div class="flex items-center rounded-control border border-line bg-surface" role="group" aria-label="Año">
            ...
            @if ($canExport && ! $annual->isEmpty())
                <x-btn variant="secondary" icon="download" :href="route('exports.annual', ['year' => $annual->year])">Exportar a Excel</x-btn>
            @endif
        </div>
    </div>
            ...
            <table class="w-full min-w-[1080px] border-collapse text-label">
                <thead class="bg-panel text-ink-600">
                    <tr>
                        ...
                        @endforeach
                        <th class="whitespace-nowrap border-l-2 border-line px-3 py-2 text-right font-semibold text-ink-900">Año</th>
                    </tr>
                </thead>
