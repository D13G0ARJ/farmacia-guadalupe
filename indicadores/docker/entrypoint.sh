...
# Siembra inicial opcional: poner RUN_SEED=true solo en el PRIMER despliegue
# (roles, sede principal, parámetros y usuario administrador). Luego quitarla.
if [ "${RUN_SEED:-false}" = "true" ]; then
  echo "==> Ejecutando db:seed (RUN_SEED=true) ..."
