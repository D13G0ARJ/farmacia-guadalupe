...
import pathlib
src = pathlib.Path("_build/doc.html").resolve().as_uri()
out = str(pathlib.Path("Especificacion Sistema Farmacia Guadalupe.pdf").resolve())
HDR = """<div style="width:100%;font-family:Inter,Segoe UI,sans-serif;font-size:6.6pt;color:#8A9AA1;
 padding:0 17mm;display:flex;justify-content:space-between;border-bottom:.5pt solid #E4E0D9;
 padding-bottom:2mm;margin-bottom:0;">
 <span style="letter-spacing:.7pt;text-transform:uppercase;">Farmacia Guadalupe, C.A.</span>
 <span style="letter-spacing:.7pt;text-transform:uppercase;">Especificaci&oacute;n funcional y t&eacute;cnica &middot; v1.0</span></div>"""
FTR = """<div style="width:100%;font-family:Inter,Segoe UI,sans-serif;font-size:6.8pt;color:#8A9AA1;
 ...
 <span style="font-weight:600;color:#0B6B5B;">
